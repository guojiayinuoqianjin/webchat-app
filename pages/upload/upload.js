...
Page({
  ...
  submitPost: function (e) {
    ...
    let imagePaths = that.data.filePaths[0];
    let categoryId = that.data.categories[that.data.categoryIndex].id;
    let categroyName = that.data.categories[that.data.categoryIndex].category_name;
    let name = e.detail.value.name;
    let address = e.detail.value.address;
    let rate =3;// parseFloat(e.detail.value.rate);
    let phone ="Coming Soon.";// e.detail.value.phone;
